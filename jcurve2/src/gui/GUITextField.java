 ...
 * @author Benjamin
 */
public class GUITextField extends AbstractComponent {
	 ...
	 */
	public GUITextField(GUIContext container, Font font, int x, int y, int width, int height, ComponentListener listener) {
	 ...
	 *            The height of the text field
	 */
	public GUITextField(GUIContext container, Font font, int x, int y, int width, int height) {
		super(container);
